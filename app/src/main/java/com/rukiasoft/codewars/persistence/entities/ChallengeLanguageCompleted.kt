...
@Entity(tableName = "challenge_language_completed", indices = [(Index(value = arrayOf("challenge_id", "name"), unique = true))])
class ChallengeLanguageCompleted constructor(@PrimaryKey(autoGenerate = true)
                                             @ColumnInfo(name = "id")
                                             val id: Int?,
